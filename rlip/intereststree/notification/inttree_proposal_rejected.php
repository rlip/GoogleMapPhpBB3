...
class inttree_proposal_rejected extends \phpbb\notification\type\base
{
    protected $titleKey = 'RLIP_INTERESTS_TREE_PROPOSAL_NOTIFICATION_TITLE';
    protected $contentKey = 'RLIP_INTERESTS_TREE_PROPOSAL_NOTIFICATION_REJECTED_TEXT';

    public static $notification_option = array(
        'lang'   => 'RLIP_INTERESTS_TREE_PROPOSAL_NOTIFICATION_REJECTED_TEXT',
        'group'   => 'NOTIFICATION_GROUP_MISCELLANEOUS',
    );

    public function get_type()
    {
        return 'rlip.intereststree.notification.type.inttree_proposal_rejected';
    }
